...
@section('title', 'Sign Up & Sign In - RoboMath')
...
<div class="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#FAF6EF] relative overflow-hidden">
    ...
    {{-- MAIN SLIDING AUTH CONTAINER (Initial state: right-panel-active for register) --}}
    <div class="auth-container right-panel-active relative w-full max-w-[880px] min-h-[580px] bg-white rounded-[32px] shadow-[0_20px_50px_rgba(249,115,22,0.12)] border border-amber-100/70 overflow-hidden z-10" id="authContainer">

        {{-- ======================================================== --}}
        {{-- 1. SIGN UP FORM CONTAINER --}}
        {{-- ======================================================== --}}
        <div class="form-container sign-up-container absolute top-0 left-0 w-full md:w-1/2 h-full flex flex-col justify-center items-center px-6 sm:px-12 py-8 text-center bg-white transition-all duration-700 ease-in-out">
            <form action="{{ route('register') }}" method="POST" class="w-full max-w-sm flex flex-col items-center">
                ...
                <div class="w-full space-y-2">
                    ...
                    {{-- Role & Kelas Selector --}}
                    <div class="grid grid-cols-2 gap-2" id="registerRoleContainer">
